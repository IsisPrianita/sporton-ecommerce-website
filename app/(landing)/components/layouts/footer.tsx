...
const Footer = () => {
  return (
    <footer className="bg-dark-alternate text-white mt-52">
      <div className="container mx-auto px-6 md:px-12 lg:px-20 flex justify-between pt-14 pb-24">
        <div className="w-105">
          <Image
            src="/assets/foto/logo-footer.svg"
      ...
      <div className="border-t border-t-white/15">
        <div className="container mx-auto px-6 md:px-12 lg:px-20 py-6.5 flex justify-between">
